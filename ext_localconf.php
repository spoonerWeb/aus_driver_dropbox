...
$TYPO3_CONF_VARS['SYS']['fal']['registeredDrivers'][\AUS\AusDriverDropbox\Driver\DropboxDriver::DRIVER_TYPE] = [
...
if (!is_array($TYPO3_CONF_VARS['SYS']['caching']['cacheConfigurations']['ausdriverdropbox_cache'])) {
    $TYPO3_CONF_VARS['SYS']['caching']['cacheConfigurations']['ausdriverdropbox_cache'] = [];

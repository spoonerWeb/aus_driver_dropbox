...
class DropboxDriver extends \TYPO3\CMS\Core\Resource\Driver\AbstractHierarchicalFilesystemDriver {
	 ...
	 * @var array
	 */
	protected $objectMetaWithChildrenCache = array();

	/**
	 * @var array
	 */
	protected $publicUrlCache = array();
	...
	public function getFileInfoByIdentifier($fileIdentifier, array $propertiesToExtract = array()) {
		if (self::DEBUG_MODE) { \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump(func_get_args(), 'Hello from ' . __METHOD__); }
	...
	protected function getObjectPermissions($identifier) {
		return $permissions = array('r' => TRUE, 'w' => TRUE);
	}
	...
	protected function getDate($dateString) {
		...
		return mktime($dateArr['tm_hour'], $dateArr['tm_min'], $dateArr['tm_sec'], $dateArr['tm_mon']+1, $dateArr['tm_mday'], $dateArr['tm_year']+1900);
	}
